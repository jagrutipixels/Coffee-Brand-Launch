    ...
    <div className="w-full h-full flex flex-col justify-center py-12 relative z-10">
      <div className="mb-20 text-center max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} className="flex items-center justify-center gap-3 mb-6">
           ...
           <p className="font-heading text-gray-900 text-xs tracking-[0.3em] uppercase">Expected Business Outcomes</p>
        ...
        <h2 className="text-5xl md:text-7xl font-heading font-light leading-[1.1] tracking-tight">
          ...
          <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-900/40">Market Domination</span>
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto w-full">
         {[
           ...
           { n: 'IPO', t: 'Ready Valuation', d: 'Structuring brand perception and systems for maximum future enterprise valuation.', c: '#ffffff', bg: 'from-gray-900/10' },
         ].map((item, i) => (
           <motion.div 
             key={i} 
             ...
             className="glass-panel p-10 rounded-[2rem] flex flex-col relative overflow-hidden group border border-gray-900/5 hover:border-gray-900/20 transition-all duration-500"
           >
              ...
              <div className="relative z-10">
                ...
                <div className="w-full h-px bg-gradient-to-r from-gray-900/20 to-transparent mb-6"></div>
                <h4 className="text-xl font-medium text-gray-900 mb-3 group-hover:translate-x-1 transition-transform">{item.t}</h4>
